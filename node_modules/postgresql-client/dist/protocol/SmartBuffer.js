...
class SmartBuffer extends BufferReader_1.BufferReader {
    constructor(cfg) {
        // @ts-ignore
        super(Buffer.allocUnsafe(((cfg === null || cfg === void 0 ? void 0 : cfg.pageSize) ? parseInt(cfg.pageSize, 10) : 0) || SmartBuffer.DEFAULT_PAGE_SIZE));
        this._lastHouseKeep = 0;
        this._stMaxPages = 1;
        this._length = 0;
        this._houseKeepInterval = (cfg === null || cfg === void 0 ? void 0 : cfg.houseKeepInterval) || 5000;
        this.pageSize = this.buffer.length;
        this.maxSize = (cfg === null || cfg === void 0 ? void 0 : cfg.maxLength) || (1024 * 1024 * 128); // 128 MB
        this._length = 0;
    }
    get capacity() {
    ...
    writeBigInt64BE(n) {
        ...
        if (typeof this.buffer.writeBigInt64BE === 'function')
            ...
            bigint_methods_1.writeBigUInt64BE(this.buffer, n, this.offset);
        this.offset += 8;
        return this;
    }
    writeFloatBE(n) {
