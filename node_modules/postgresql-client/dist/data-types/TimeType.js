...
exports.TimeType = {
    ...
    encodeBinary(buf, v, options) {
        if (typeof v === 'string')
            v = parse_time_1.parseTime(v, false, options.utcDates);
    ...
    parseText(v, options) {
        if (options.fetchAsString && options.fetchAsString.includes(definitions_1.DataTypeOIDs.time))
            return v;
        return parse_time_1.parseTime(v, false, options.utcDates);
    },
    isType(v) {
...
exports.ArrayTimeType = Object.assign(Object.assign({}, exports.TimeType), { name: '_time', oid: definitions_1.DataTypeOIDs._time, elementsOID: definitions_1.DataTypeOIDs.time });
